                ...
                <main class="dt-main">
                    ...
                    <aside id="main-sidebar" class="dt-sidebar ps ps--active-y">
                        ...
                        <div class="dt-sidebar__container mt-10">
                            ...
                            <?php
								if ($this->user_model->getPermissions('cms', 'home_cms', 0, $userId) OR
								$this->user_model->getPermissions('cms', 'home_cms', 1, $userId) OR
								$this->user_model->getPermissions('cms', 'home_cms', 2, $userId) OR
								$this->user_model->getPermissions('cms', 'home_cms', 3, $userId) OR
								$this->user_model->getPermissions('cms', 'home_cms', 4, $userId) OR
								$role == ROLE_ADMIN) { ?>
                                
                            <li
                            class="dt-side-nav__item <?php if($this->uri->segment(1)=="cms"){echo "selected open";}?>">
                                    <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                        title="Home CMS">
                                        <i class="fas fa-home"></i><span
                                            class="dt-side-nav__text">Home CMS</span> </a>                                         
                                            
                                            <!-- Sub-menu -->
                                    <ul class="dt-side-nav__sub-menu <?php echo $this->uri->segment(1)=="cms" ? "display-b" : "display-n"?>">
                                    
									<?php
									if ($this->user_model->getPermissions('cms', 'home_cms', 0, $userId) OR $role == ROLE_ADMIN) { ?>                                 
                                        <li class="dt-side-nav__item open <?php if($this->uri->segment(1)=="cms" && $this->uri->segment(2)=="home_cms" && $this->uri->segment(3)== 0){echo "selected";}?>">
                                        
											<a href="<?php echo base_url(); ?>cms/home_cms/0" 
											class="dt-side-nav__link <?php if($this->uri->segment(1)=="cms" && $this->uri->segment(2)=="home_cms" && $this->uri->segment(3)== 0){echo "active";}?>" 
											title="Content List"> 
											<span class="dt-side-nav__text">Content List</span> </a>
                                        </li>
                                     <?php }?>
                                     
                                     <?php if ($this->user_model->getPermissions('cms', 'home_cms', 1, $userId) OR $role == ROLE_ADMIN) { ?> 
                                        <li
                                            class="dt-side-nav__item open ">
											<a href="<?php echo base_url(); ?>cms/home_cms/1" 
											class="dt-side-nav__link <?php if($this->uri->segment(1)=="cms" && $this->uri->segment(2)=="home_cms" && $this->uri->segment(3)== 1){echo "active";}?> " 
											title="Slider"> 
                                    ...
                                    <?php if ($this->user_model->getPermissions('cms', 'home_cms', 2, $userId) OR $role == ROLE_ADMIN) { ?> 
										<li
                                            class="dt-side-nav__item open ">
											<a href="<?php echo base_url(); ?>cms/home_cms/2" 
											class="dt-side-nav__link <?php if($this->uri->segment(1)=="cms" && $this->uri->segment(2)=="home_cms" && $this->uri->segment(3)== 2){echo "active";}?> " 
											title="Graph">
											<span class="dt-side-nav__text">Graph</span> </a>
										</li>
									<?php } ?>
									
									<?php if ($this->user_model->getPermissions('cms', 'home_cms', 3, $userId) OR $role == ROLE_ADMIN) { ?> 
										<li
                                            class="dt-side-nav__item open ">
											<a href="<?php echo base_url(); ?>cms/home_cms/3" 
											class="dt-side-nav__link <?php if($this->uri->segment(1)=="cms" && $this->uri->segment(2)=="home_cms" && $this->uri->segment(3)== 3){echo "active";}?> " 
											title="Blogs">
											<span class="dt-side-nav__text">Blogs</span> </a>
										</li>
									<?php } ?>
									
									<?php if ($this->user_model->getPermissions('cms', 'home_cms', 4, $userId) OR $role == ROLE_ADMIN) { ?> 
										<li
                                            class="dt-side-nav__item open ">
											<a href="<?php echo base_url(); ?>cms/home_cms/4" 
											class="dt-side-nav__link <?php if($this->uri->segment(1)=="cms" && $this->uri->segment(2)=="home_cms" && $this->uri->segment(3)== 4){echo "active";}?> " 
											title="Paymnet Mehods">
								...
								<?php
								if ($this->user_model->getPermissions('cms', 'home_cms', 5, $userId) OR $role == ROLE_ADMIN) { ?>
								<li class="dt-side-nav__item">
									<a href="<?php echo base_url(); ?>cms/home_cms/5" 
                                            class="dt-side-nav__link <?php
											if ($this->uri->segment(1)=="cms" && $this->uri->segment(2)=="home_cms"  && $this->uri->segment(2)== 5) {
										echo "active";} ?>"
                                            title="About Us">
											<i class="fa fa-users"></i>
										<span class="dt-side-nav__text">About Us</span> </a>
								</li>
								<?php } ?>
