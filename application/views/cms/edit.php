						...
						<form id="cms_form" method="post">
							...
							<input type="hidden" name="<?=$csrf['name']; ?>" value="<?=$csrf['hash']; ?>" />
								...
								<div class="form-group">
									<label>Title</label>
									<input type="text" class="form-control" id="title" value="<?php echo $details->title; ?>"  name="title" required >
								</div>
								
								
								<div class="form-group">
									<label>Subtitle</label>
									<input type="text" class="form-control" id="sub_title" value="<?php echo $details->sub_title; ?>" name="sub_title" required >
								</div>
								<div class="form-group">
									<label>Description</label>
									<input type="text" class="form-control" id="description" value="<?php echo $details->description; ?>" name="description" required >
								</div>								
