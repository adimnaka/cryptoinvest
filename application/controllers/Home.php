...
class Home extends BaseController {
	...
	public function index()
	{
		...
		$this->db->where('tbl_homecms.type',1);
		$query = $this->db->get();
		...
		$this->db->select('*');
		$this->db->from('tbl_homecms');
		$this->db->where('tbl_homecms.type',2);
		$query = $this->db->get();
		$data['graph']=$query->result();
		
		//------4 services------\\
		$this->db->select('*');
		$this->db->from('tbl_homecms');
		$this->db->where('tbl_homecms.type',0);
		$list_ids = array(5,24);
		$this->db->where_not_in('tbl_homecms.id',
		$list_ids, FALSE);
		$query = $this->db->get();
		$data['cmslist']=$query->result();
		
		//-----cross platform----\\
		$this->db->select('*');
		$this->db->from('tbl_homecms');
		$this->db->where('tbl_homecms.type',0);
		$this->db->where('tbl_homecms.id',5);
		$query = $this->db->get();
		$data['platforms']=$query->result();
		
		//-------------news,analysis & etc-------\\
		$this->db->select('*');
		$this->db->from('tbl_homecms');
		$this->db->where('tbl_homecms.type',3);
		$query = $this->db->get();
		$data['blogs']=$query->result();

		//-------Paymnt Methods icons-----\\
		$this->db->select('*');
		$this->db->from('tbl_homecms');
		$this->db->where('tbl_homecms.type',4);
		$query = $this->db->get();
		$data['payment_methods']=$query->result();	
		
		//-------------latest payouts------------//
		$data['transactions'] = $this->transactions_model->allEarnings('', 5, '', date('Y-m-d H:i:s'));
		
		$this->db->select('*');
		$this->db->from('tbl_homecms');
		$this->db->where('tbl_homecms.type',0);
		$this->db->where('tbl_homecms.id',24);
		$query = $this->db->get();
		$data['about_pay']=$query->result();
			
		$template = $companyInfo['template'];
		
		$header = '/siteContent/template3/partials/header';
		$view = '/siteContent/template3/home';
		$footer = '/siteContent/template3/partials/footer';
	...
	public function contact_us()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$toEmail = 'arunangshupradhan17@gmail.com';
	...
	public function our_contact ()
	{
		...
		$header = '/siteContent/template3/partials/header';
		$view = '/siteContent/template3/contact_us';
		$footer = '/siteContent/template3/partials/footer';
	...
	public function about_us () {
		$this->db->select('*');
		$this->db->from('tbl_homecms');
		$this->db->where('tbl_homecms.type',5);
		$query = $this->db->get();
		...
		$header = '/siteContent/template3/partials/header';
		$view = '/siteContent/template3/about_us';
		$footer = '/siteContent/template3/partials/footer';
	...
	public function faqs()
	{
		...
		$header = '/siteContent/template3/partials/header';
		$view = '/siteContent/template3/faqs';
		$footer = '/siteContent/template3/partials/footer';
	...
	public function privacy()
	{
		...
		$header = '/siteContent/template3/partials/header';
		$view = '/siteContent/template3/privacy';
		$footer = '/siteContent/template3/partials/footer';
	...
	public function terms()
	{
		...
		$header = '/siteContent/template3/partials/header';
		$view = '/siteContent/template3/terms';
		$footer = '/siteContent/template3/partials/footer';
